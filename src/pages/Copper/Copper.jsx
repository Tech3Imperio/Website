			...
			<div className="copper-main-content">
				...
				<div className="copper-extras">
					<div className="copper-extras-divs">
						<h3 className="header">
							Cu ETP and Copper Tellurium Products
						</h3>
						<p>
							In marine conditions, these alloys are prone to
							selective corrosion. One of the alloys in this grade
							is the
							<strong> Copper Tellurium</strong>, which is also
							referred to as
							<strong> alloy 45</strong>. These alloys can be
							easily machined and fabricated. They have a melting
							point of about 1080 degrees C. In the
							<strong> Copper Alloy</strong> composition, copper
							is a major constituent. Apart from this nickel, tin,
							zinc, sulfur, silicon, aluminum, lead, phosphorous,
							tin, and antinomy are a few elements that can
							combine with copper in various systems.
						</p>
						<p>
							...
							. It has a minimum tensile strength of{" "}
							<strong>170Mpa</strong> and a minimum yield strength
							of <strong>83Mpa</strong>. It can be easily
							elongated by <strong>12%</strong> and used
							efficiently in various applications. A few of the
							Copper Products are <strong>pipes</strong>,{" "}
							<strong>tubes</strong>, <strong>wires</strong>,{" "}
							<strong>rods</strong>, <strong>cathodes</strong>,{" "}
							<strong>cables</strong>, etc. These products are
							very <strong>reliable</strong> and{" "}
							<strong>cost-efficient</strong>. They can be easily{" "}
							<strong>cleaned</strong> and have a{" "}
							<strong>long service life</strong>. The Copper Price
							Per Pound in India is between{" "}
							<strong>Rs 280</strong> to <strong>Rs 350</strong>.
							The price is dependent on the growth of the global
							economy so, it keeps on <strong>fluctuating</strong>{" "}
							every day. If you have any queries or want to know
							more about any of our grades or products,{" "}
