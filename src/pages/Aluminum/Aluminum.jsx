			...
			<div className="aluminum-main-content">
				...
				<div className="aluminum-extras">
					<div className="aluminum-extras-divs">
						...
						<p>
							Aluminum alloys can be classified into different
							series based on their composition and properties.
							For instance, the 1000 series primarily consists of
							pure aluminum, while the 6000 series contains
							silicon and magnesium, offering good formability and
							weldability. One of the popular alloys is Aluminum
							Alloy 6061, known for its excellent machinability
							and structural strength. It has a density of about
							2.70 g/cm³, a tensile strength ranging from 124-290
							MPa, and a yield strength of 55-240 MPa depending on
							the temper.
						</p>
						<p>
							Aluminum alloys can be classified into different
						...
						<p>
							In terms of pricing, the cost of aluminum per pound
							fluctuates based on market demand, supply chain
							dynamics, and global economic conditions. As of now,
							the price range for Aluminum Alloys in India varies
							from Rs 150 to Rs 200 per kilogram, but it's
							advisable to check current market rates for accurate
							pricing information.
						</p>
					</div>
					<div className="aluminum-extras-divs">
							...
							<tbody>
								{aluminumMechProperties.map((data, index) => (
									<tr key={index}>
										...
										<td>
											{data.CoefficientOfThermalExpansion}
										</td>
					...
					<div className="aluminum-extras-divs">
						...
						<ul className="aluminum-list">
							...
							<li>
								Building and construction materials (e.g.,
								windows, doors, roofing)
							</li>
							<li>Educational and industrial equipment</li>
							<li>
								Electrical transmission lines and conductors
							</li>
							<li>
								Food and beverage packaging (e.g., cans, foils)
							</li>
							<li>Household items (e.g., utensils, furniture)</li>
							<li>Marine and offshore structures</li>
							<li>Medical devices and equipment</li>
							<li>
								Sports and recreational equipment (e.g.,
								bicycles, boats)
							</li>
						</ul>
					</div>
