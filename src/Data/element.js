import { imageProduct } from "../pages/@assets/image";
...
export const elementsData = {
  ...
  copper: [
    ...
    <>
      <p>
        ...
        <strong>Copper</strong> is a chemical element, which is used in making
        highly ductile and malleable products in the piping industry.
      </p>
      <p>
        The products produced from this element possess high thermal and
        excellent electrical conductivity. A <strong>Copper Alloy</strong> is
        placed in the category of red metals. These metals have a distinct tint
        of a reddish color. These alloys occur naturally and show good
  ...
  nickel: [
    {
      src: imageProduct[4],
      altText: "Nickel Alloy",
    },
    <>
      <p>
        The strength and corrosion resistance of Nickel Alloy are well
        recognized. It is used to weld different metals. Visit Kalpurna to learn
        more about its benefits.
      </p>
      <p>
        Nickel alloys are metallic materials made from combining nickel with
        other elements, such as chromium, iron, copper, and molybdenum, among
        others. They are known for their exceptional corrosion resistance,
